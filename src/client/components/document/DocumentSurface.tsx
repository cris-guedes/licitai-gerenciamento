  ...
  return (
    <div className={cn("relative min-h-0 overflow-hidden bg-white", className)}>
      ...
      {currentStatus === "error" ? (
        <div
          className={cn(
            "absolute inset-0 z-10 flex flex-col items-center justify-center gap-4 bg-background px-6 text-center text-muted-foreground",
            fallbackClassName,
          )}
        >
          <AlertCircle className="size-10 opacity-30" />
          <p className="text-sm">Nao foi possivel abrir este PDF no visualizador nativo.</p>
