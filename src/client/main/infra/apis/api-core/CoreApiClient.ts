...
import { EditalAnalysisService } from './services/EditalAnalysisService';
...
export class CoreApiClient {
  ...
  public readonly editalAnalysis: EditalAnalysisService;
  ...
  constructor(config?: Partial<OpenAPIConfig>, HttpRequest: HttpRequestConstructor = AxiosHttpRequest) {
    ...
    this.editalAnalysis = new EditalAnalysisService(this.request);
