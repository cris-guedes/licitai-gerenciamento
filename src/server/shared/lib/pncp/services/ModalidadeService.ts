...
export class ModalidadeService {
   ...
   * @throws ApiError
   */
  public static obterTodosRegistros3({
    statusAtivo,
  }: {
    statusAtivo?: boolean,
   ...
   * @throws ApiError
   */
  public static incluirRegistro4({
    requestBody,
  }: {
   ...
   * @throws ApiError
   */
  public static alterarParcialmenteRegistro3({
    id,
    requestBody,
  }: {
    id: number,
