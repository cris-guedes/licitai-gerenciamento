...
export class CritRioDeJulgamentoService {
   ...
   * @throws ApiError
   */
  public static incluirRegistro7({
    requestBody,
  }: {
   ...
   * @returns DominioGenericoDTO OK
   * @throws ApiError
   */
  public static obterRegistro8({
    id,
  }: {
    id: number,
  }): CancelablePromise<DominioGenericoDTO> {
    return __request(OpenAPI, {
      method: 'GET',
      url: '/v1/criterios-julgamentos/{id}',
      path: {
        'id': id,
      },
      errors: {
   ...
   * @throws ApiError
   */
  public static alterarParcialmenteRegistro5({
    id,
    requestBody,
  }: {
    id: number,
