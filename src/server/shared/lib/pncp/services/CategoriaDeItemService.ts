...
export class CategoriaDeItemService {
  /**
   * Consultar categorias de item
   * @returns any OK
   * @throws ApiError
   */
  public static obterTodosRegistros6({
    statusAtivo,
  }: {
    statusAtivo?: boolean,
   ...
   * @throws ApiError
   */
  public static incluirRegistro8({
    requestBody,
  }: {
   ...
   * @throws ApiError
   */
  public static alterarParcialmenteRegistro6({
    id,
    requestBody,
  }: {
    id: number,
