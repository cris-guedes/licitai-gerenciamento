...
export class ModoDeDisputaService {
  /**
   * Consultar modos de disputas
   * @returns any OK
   * @throws ApiError
   */
  public static obterTodosRegistros2({
    statusAtivo,
  }: {
    statusAtivo?: boolean,
   ...
   * @throws ApiError
   */
  public static incluirRegistro3({
    requestBody,
  }: {
   ...
   * @throws ApiError
   */
  public static alterarParcialmenteRegistro2({
    id,
    requestBody,
  }: {
    id: number,
