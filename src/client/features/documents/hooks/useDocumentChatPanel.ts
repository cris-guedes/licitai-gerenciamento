...
import type { DocumentChatMessage, useDocumentChatService } from "@/client/features/licitacoes/services/use-document-chat.service"
...
export function useDocumentChatPanel({ open, documentId, documentChatService }: Props) {
  ...
  async function handleClearChat() {
    ...
    const confirmed = window.confirm("Deseja limpar todo o historico deste chat do documento?")
    if (!confirmed) return
