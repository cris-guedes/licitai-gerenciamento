...
/* tslint:disable */
/* eslint-disable */
import type { CodeFormulaVlmOptions } from './CodeFormulaVlmOptions';
...
import type { PictureDescriptionApi } from './PictureDescriptionApi';
import type { PictureDescriptionLocal } from './PictureDescriptionLocal';
import type { PictureDescriptionVlmEngineOptions } from './PictureDescriptionVlmEngineOptions';
import type { ProcessingPipeline } from './ProcessingPipeline';
import type { TableFormerMode } from './TableFormerMode';
import type { VlmConvertOptions } from './VlmConvertOptions';
import type { VlmModelApi } from './VlmModelApi';
import type { VlmModelLocal } from './VlmModelLocal';
import type { VlmModelType } from './VlmModelType';
export type ConvertDocumentsRequestOptions = {
  /**
   ...
   */
  vlm_pipeline_custom_config?: (VlmConvertOptions | Record<string, any> | null);
  /**
   * Custom picture description configuration including model spec and engine options.
   */
  picture_description_custom_config?: (PictureDescriptionVlmEngineOptions | Record<string, any> | null);
  /**
   * Custom code/formula extraction configuration including model spec and engine options.
   */
  code_formula_custom_config?: (CodeFormulaVlmOptions | Record<string, any> | null);
  /**
